    ...
    public struct Money {
        ...
        public override string ToString() {
            ...
            if (SEconomyPlugin.Configuration.MoneyConfiguration.UseQuadrantNotation) {
                ...
                sb.AppendFormat("{0} {1}", this.Value.ToString(SEconomyPlugin.Configuration.MoneyConfiguration.SingularDisplayFormat, new System.Globalization.CultureInfo(SEconomyPlugin.Configuration.MoneyConfiguration.SingularDisplayCulture)), this.Value != 1 || this.Value != -1 ? SEconomyPlugin.Configuration.MoneyConfiguration.MoneyNamePlural : SEconomyPlugin.Configuration.MoneyConfiguration.MoneyName);
            }
        ...
        public string ToLongString(bool ShowNegativeSign = false) {
            ...
            if (SEconomyPlugin.Configuration.MoneyConfiguration.UseQuadrantNotation) {
                ...
                sb.AppendFormat("{0} {1}", this.Value.ToString(SEconomyPlugin.Configuration.MoneyConfiguration.SingularDisplayFormat, new System.Globalization.CultureInfo(SEconomyPlugin.Configuration.MoneyConfiguration.SingularDisplayCulture)),
                    this.Value == 1 || this.Value == -1 ? SEconomyPlugin.Configuration.MoneyConfiguration.MoneyName.ToLowerInvariant() : SEconomyPlugin.Configuration.MoneyConfiguration.MoneyNamePlural.ToLowerInvariant());
        ...
        public static string CurrencyName {
            get {
                if (!SEconomyPlugin.Configuration.MoneyConfiguration.UseQuadrantNotation) {
                    return SEconomyPlugin.Configuration.MoneyConfiguration.MoneyName.ToLowerInvariant();
                } else {
                    return "";
                }
            }
